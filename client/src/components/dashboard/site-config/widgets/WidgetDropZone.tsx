...
export function WidgetDropZone({ onDrop, isAddWidgetMode, children, className = '' }: WidgetDropZoneProps) {
  ...
  return (
    <div
      ref={dropZoneRef}
      className={`relative ${className} ${isAddWidgetMode ? 'widget-drop-zone-active' : ''}`}
    ...
    >
      ...
      {isAddWidgetMode && isDragOver && (
        <div className="absolute inset-0 bg-blue-500/10 border-2 border-dashed border-blue-500 rounded-lg pointer-events-none z-50">
