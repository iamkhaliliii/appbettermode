        ...
        <div className="p-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div className="hover-translate">
              <div className="text-sm text-gray-700 dark:text-zinc-200">@{username}</div>
              <div className="text-xs text-gray-500 dark:text-zinc-500">{timeAgo}</div>
            </div>
          </div>
          <button 
            onClick={onAddMember || (() => console.log('Add member clicked'))}
