    ...
    >
      <div className="divide-y divide-zinc-200 dark:divide-zinc-800">
        <div className="p-6">
          ...
          {/* Event section */}
          {content?.event && (
            <div className="mb-4 rounded-xl bg-zinc-50 border border-zinc-200 dark:border-zinc-700 overflow-hidden bg-white dark:bg-zinc-900 hover:border-zinc-300 dark:hover:border-zinc-600 transition-all duration-300 cursor-pointer group">
              <div className="p-4">
                <div className="flex items-start gap-5">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-3 mb-2">
                      {/* Category Badge */}
                      <Badge className="bg-zinc-200/50 dark:bg-zinc-800 text-zinc-600 dark:text-zinc-400 text-[0.75rem] px-1.5 py-0.5 font-medium border-0 rounded-md">
                        {content.event.category}
                      </Badge>
                      
                      {/* Time */}
                      <span className="text-[0.7rem] font-medium text-zinc-700 dark:text-zinc-300">
                        {content.event.date} • {content.event.time}
                      </span>
                      
                      {/* Status Badge */}
                      {content.event.status === 'ongoing' && (
                        <Badge className="bg-red-600 text-white text-xs px-2 py-0.5">
                          Live
                        </Badge>
                      )}
                      {content.event.status === 'completed' && (
                    ...
                    {/* Title */}
                    <h4 className="font-semibold text-[1rem] mb-4 mt-2 line-clamp-2 text-zinc-900 dark:text-zinc-100">
                      {content.event.title} 
                      <ArrowRight className="inline w-5 h-5 text-zinc-400 group-hover:text-zinc-600 dark:group-hover:text-zinc-300 opacity-0 group-hover:opacity-100 transform translate-x-0 group-hover:translate-x-1 transition-all duration-300 ml-1" />
                    </h4>
                    
                    {/* Attendees, Host and Location Info */}
                    <div className="flex items-center gap-2 text-[0.8rem] text-zinc-600 dark:text-zinc-400">
                      {/* Attendees */}
                      <div className="flex items-center gap-2">
                        <span className="text-xs text-zinc-500 dark:text-zinc-400 font-medium">
                        ...
                        {content.event.host && (
                          <div className="flex items-center gap-1">
                            <span className="text-xs text-zinc-500 dark:text-zinc-400 font-medium">
                              Hosted by {content.event.host.name}
                            </span>
                          </div>
                        )}
                      ...
                      {content.event.location && (
                        <div className="flex items-center gap-1">
                          ...
                          <span className="truncate max-w-[120px]">{content.event.location}</span>
                        </div>
                      )}
                    </div>
                  </div>
                  ...
                  <div className="flex-shrink-0 relative">
                    <div className="w-10 h-10 rounded-lg bg-zinc-100 dark:bg-zinc-800 flex items-center justify-center group-hover:bg-zinc-200 dark:group-hover:bg-zinc-700 transition-colors duration-300">
