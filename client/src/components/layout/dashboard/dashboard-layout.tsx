...
// Memoize the mobile menu to prevent unnecessary rerenders
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-100 dark:bg-gray-950"> {/* Updated background color */}
      ...
      <div className="flex-1 flex flex-col md:flex-row">
        ...
        <main className="flex-1 bg-gray-50 dark:bg-gray-900 overflow-y-auto scrollbar-thin scrollbar-thumb-gray-100 dark:scrollbar-thumb-gray-700 min-h-[calc(100vh-4rem)]"> {/* Changed main content background */}
