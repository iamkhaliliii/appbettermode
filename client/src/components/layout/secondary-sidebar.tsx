...
function SideNavItem({ href, icon, children, isActive, badge }: SideNavItemProps) {
  return (
      <Link href={href}>
        <div
          className={cn(
            "flex items-center px-3 py-2 text-sm rounded-md cursor-pointer my-0.5",
            isActive 
...
export function SecondarySidebar() {
  ...
  return (
    <aside className="secondary-sidebar bg-white border-r border-gray-200 h-[calc(100vh-4rem)] overflow-y-auto sticky top-16 w-64">
      <div className="p-5">
        <div className="mb-6">
