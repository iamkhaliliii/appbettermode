                      ...
                      <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                        ...
                        <DropdownMenu>
                          ...
                          <DropdownMenuContent align="end" className="w-36 py-1 shadow-md border border-gray-100 dark:border-gray-700 bg-white dark:bg-gray-800">
                            <DropdownMenuItem className="flex items-center text-[10px] py-1 px-2 cursor-pointer hover:bg-gray-50/50 dark:hover:bg-gray-700/50 text-gray-600 dark:text-gray-300">
                            ...
                            <DropdownMenuItem className="flex items-center text-[10px] py-1 px-2 cursor-pointer hover:bg-red-50 dark:hover:bg-red-900/10 text-red-600 dark:text-red-400">
