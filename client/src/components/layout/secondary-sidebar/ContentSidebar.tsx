      ...
      <div className="space-y-4">
        <div className="space-y-3">
          ...
          <div className="space-y-0.5 border-t border-gray-100 dark:border-gray-700 pt-2">
            <SideNavItem
              href={APP_ROUTES.DASHBOARD_SITE.CONTENT_SECTION(currentSiteIdentifier, APP_ROUTES.CONTENT_TYPES.EVENTS)}
              isActive={isActiveUrl && isActiveUrl(APP_ROUTES.DASHBOARD_SITE.CONTENT_SECTION(currentSiteIdentifier, APP_ROUTES.CONTENT_TYPES.EVENTS), currentPathname)}
            ...
            <SideNavItem
              href={APP_ROUTES.DASHBOARD_SITE.CONTENT_SECTION(currentSiteIdentifier, APP_ROUTES.CONTENT_TYPES.DISCUSSIONS)}
              isActive={isActiveUrl && isActiveUrl(APP_ROUTES.DASHBOARD_SITE.CONTENT_SECTION(currentSiteIdentifier, APP_ROUTES.CONTENT_TYPES.DISCUSSIONS), currentPathname)}
            ...
            <SideNavItem
              href={APP_ROUTES.DASHBOARD_SITE.CONTENT_SECTION(currentSiteIdentifier, APP_ROUTES.CONTENT_TYPES.ARTICLES)}
              isActive={isActiveUrl && isActiveUrl(APP_ROUTES.DASHBOARD_SITE.CONTENT_SECTION(currentSiteIdentifier, APP_ROUTES.CONTENT_TYPES.ARTICLES), currentPathname)}
            ...
            <SideNavItem
              href={APP_ROUTES.DASHBOARD_SITE.CONTENT_SECTION(currentSiteIdentifier, APP_ROUTES.CONTENT_TYPES.QUESTIONS)}
              isActive={isActiveUrl && isActiveUrl(APP_ROUTES.DASHBOARD_SITE.CONTENT_SECTION(currentSiteIdentifier, APP_ROUTES.CONTENT_TYPES.QUESTIONS), currentPathname)}
            ...
            <SideNavItem
              href={APP_ROUTES.DASHBOARD_SITE.CONTENT_SECTION(currentSiteIdentifier, APP_ROUTES.CONTENT_TYPES.WISHLIST)}
              isActive={isActiveUrl && isActiveUrl(APP_ROUTES.DASHBOARD_SITE.CONTENT_SECTION(currentSiteIdentifier, APP_ROUTES.CONTENT_TYPES.WISHLIST), currentPathname)}
