...
export default function Appearance() {
  ...
  const [, params] = useRoute('/appearance/:section');
  const section = params?.section;

  // Redirect to the first tab (logos) if we're at the root appearance route
  useEffect(() => {
    if (location === '/appearance') {
      setLocation('/appearance/logos');
    }
      ...
      <div className="max-w-7xl mx-auto p-4">
        ...
        <div className="bg-white dark:bg-gray-800 shadow-sm rounded-lg p-6 border border-gray-200 dark:border-gray-700">
          <div className="text-center py-12">
            <h2 className="text-lg font-medium text-gray-900 dark:text-white mb-2">Appearance Settings</h2>
