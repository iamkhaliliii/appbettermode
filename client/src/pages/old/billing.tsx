...
export default function Billing() {
  ...
  // Redirect to the first tab (summary) if we're at the root billing route
  useEffect(() => {
    if (location === '/billing') {
      setLocation('/billing/summary');
    }
  }, [location, setLocation]);

  // If we're at the root billing URL, show a loading state until the redirect happens
  if (location === '/billing') {
    return <DashboardLayout><div className="p-8">Loading billing information...</div></DashboardLayout>;
  }
      ...
      <div className="max-w-7xl mx-auto p-4">
        ...
        <div className="bg-white dark:bg-gray-800 shadow-sm rounded-lg p-6 border border-gray-200 dark:border-gray-700">
          <div className="text-center py-12">
            <h2 className="text-lg font-medium text-gray-900 dark:text-white mb-2">Billing Information</h2>
