...
export default function SiteSearchSettingsPage() {
  ...
  const [, params] = useRoute('/dashboard/site/:siteId/settings/search');
  ...
  return (
    <DashboardLayout currentSiteId={siteId} siteName={siteName}>
      <div className="max-w-7xl mx-auto p-4">
        <div className="mb-8">
          <h1 className="text-2xl font-semibold text-gray-900 dark:text-white">{siteName} Search Settings</h1>
